...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex flex-col gap-4 items-center rounded-2xl bg-gray-50 dark:bg-neutral-900 py-4 px-2 border border-gray-200 dark:border-neutral-800",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-gray-200 dark:bg-neutral-800 flex items-center justify-center relative group"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
